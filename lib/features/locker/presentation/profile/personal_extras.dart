...
enum PwaInstallPlatform { ios, android }
...
class _PwaInstallCardState extends ConsumerState<_PwaInstallCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final isMobileWeb = env.isAppleMobileWeb || env.isAndroidMobileWeb;
    if (_dismissed != false || !isMobileWeb || env.isStandalone) {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              padding: EdgeInsets.only(top: 13, right: 9, bottom: 6),
              child: Text(
            ...
            Align(
              ...
              child: TextButton(
                ...
                style: TextButton.styleFrom(foregroundColor: EncbaColors.timeMarker),

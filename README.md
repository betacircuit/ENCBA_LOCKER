...
부원은 앞으로 예정된 상대 운영 중 하나를 골라 자신의 운영과 맞교환을 신청합니다. 상대가 수락할 때 두 배정은 하나의 DB 트랜잭션으로 함께 바뀌며, 요청자는 임의로 다른 사람의 배정을 수정할 수 없습니다. 로그인한 모든 부원은 과거를 포함한 전체 IB 운영 배정을 시간순으로 볼 수 있고, 같은 공용 목록이 PLANNER에도 표시됩니다. 수정 권한은 관리자에게만 있습니다.
